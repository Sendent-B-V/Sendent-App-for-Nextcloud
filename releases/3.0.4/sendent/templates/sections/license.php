    ...
    <div class="license-settings-setting-box" id="licenseMessage">
        <div class="settingkeyvalue">
            ...
            <div class="labelFullWidth" id="lblLicenseMessage"
                ...
                <p>Find out how to configure your license <a style="color:blue;text-decoration:underline"  href="https://help.sendent.com/sendent-app-for-nextcloud-outlook-ms-teams/how-to-configure-your-license-information-on-the-sendent-server-app">here</a>.</p>
